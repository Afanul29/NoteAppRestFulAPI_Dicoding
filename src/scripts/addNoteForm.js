export default class AddNoteForm extends HTMLElement {
    ...
    renderForm() {
        ...
        form.innerHTML = `
            ...
            <textarea id="body" name="body" rows="4" cols="50" required minlength="0" maxlength="1000"></textarea><br><br>
    ...
    setupFormSubmission() {
        ...
        form.addEventListener('submit', event => {
            ...
            if (form.checkValidity()) {
                ...
                .then(data => {
                    console.log('Note Berhasil Dibuat:', data);
                    const eventToAddNote = new CustomEvent('newNoteAdded', { detail: { title, body } });
                    document.dispatchEvent(eventToAddNote);
                    form.reset(); // Mengosongkan formulir setelah dikirim
                    errorMessage.textContent = ''; 
                    // Menghapus pesan error setelah pengiriman
    
                    // Menampilkan alert dengan SweetAlert2
                    Swal.fire({
                        icon: 'success',
                        title: 'Catatan berhasil ditambahkan Broo!',
                ...
                errorMessage.textContent = 'Harap isi dengan benar ya !.'; 
        ...
        titleInput.addEventListener('input', () => {
            if (!titleInput.validity.valid) {
                titleInput.setCustomValidity('Judul harus terdiri dari 0 hingga 20 karakter.');
            } else {
        ...
        bodyInput.addEventListener('input', () => {
            if (!bodyInput.validity.valid) {
                bodyInput.setCustomValidity('Isi harus terdiri dari 0 hingga 1000 karakter.');
            } else {
