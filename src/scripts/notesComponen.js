export default class NotesComponent extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.renderLoading(); // Tampilkan loading
        setTimeout(() => {
            this.fetchNotes(); // Panggil method untuk mengambil catatan dari server
        }, 2000);
    }
    ...
    renderNotes() {
        ...
        this.notes.forEach((note, index) => {
            ...
            noteElement.innerHTML = `
                ...
                <button class="delete-button" data-note-id="${note.id}">Hapus</button>
                <button class="detail-button" data-note-id="${note.id}">View</button>
            `;
    ...
    handleNewNoteAdded(event) {
        ...
        // Tambahkan catatan baru ke dalam catatan
    ...
    handleDeleteNote(event) {
        ...
        .then(data => {
            ...
            this.renderNotes();
            console.log('Note delete successfully:', data); 
            // Menampilkan pesan ke konsol jika penghapusan berhasil
            Swal
            .fire({
                icon: 'success',
                title: 'Success',
            ...
            .then(note => {
                ...
                Swal.fire({
                    ...
                    html: `
                        ...
                        <p><strong>Arsip:</strong> ${note.archived}</p>
                    `,
